...
////////////////////////////////////////////////////////////////////////////////// 	
//IO方向设置
#define SDA_IN()  {GPIOE->MODER&=~(3<<(15*2));GPIOE->MODER|=0<<15*2;}	//PE15输入模式
#define SDA_OUT() {GPIOE->MODER&=~(3<<(15*2));GPIOE->MODER|=1<<15*2;} //PE15输出模式
//IO操作
...
#define READ_SDA    HAL_GPIO_ReadPin(GPIOE,GPIO_PIN_15)  //输入SDA
